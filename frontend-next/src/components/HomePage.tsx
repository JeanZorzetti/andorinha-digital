...
import { Target, Zap, Diamond, TrendingUp, Palette, Monitor, Video, RefreshCw, Layers, Camera, CheckCircle2, Clock, Shield, ClipboardList, Crosshair, Settings, Rocket, ArrowRight, Quote, Smartphone, Film, Clapperboard } from "lucide-react";
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex justify-center mb-6">
                <AnimatedGradientText>
                  <span className={cn(
                    ...
                    Audiovisual Estratégico para PMEs
                  </span>
                </AnimatedGradientText>
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-heading text-white mb-6 animate-fade-in slogan-hero tracking-wide">
                Voe Certo. Voe Alto com Audiovisual
                <br />
                <span className="mt-2 block text-primary-foreground">Estratégico</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8 animate-slide-up">
                Transformamos seu audiovisual em resultados reais. Estratégia + Execução + Transparência para PMEs que pensam grande.
              </p>
