          ...
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                Ao utilizar nosso site ou contratar nossos serviços, você
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li>
                  Enviar comunicações sobre nossos serviços (quando autorizado)
                </li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                <li>
                  <strong>Prestadores de serviço:</strong> Empresas que nos
                  auxiliam na operação do site e prestação de serviços
                  (hospedagem, e-mail marketing, analytics)
                </li>
                <li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li>
                  <strong>Cookies de marketing:</strong> Para campanhas
                  publicitárias direcionadas
                </li>
              </ul>
              <p className="text-muted-foreground mt-4">
                Você pode gerenciar suas preferências de cookies através do
                banner exibido em sua primeira visita ou nas configurações do
                seu navegador.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                <li>
                  ...
                  <a
                    href="mailto:privacidade@andorinha.roilabs.com.br"
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                perda, destruição ou alteração. Isso inclui criptografia SSL,
                controle de acesso restrito e backups regulares. No entanto,
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                obrigações legais, contratuais e regulatórias. Dados de leads
                são mantidos por até 2 anos após o último contato. Dados de
                clientes são mantidos por 5 anos após o término do contrato,
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                através do site ou por e-mail. Recomendamos revisar esta página
                regularmente para se manter informado sobre como protegemos seus
                dados.
              </p>
            </div>
