            ...
            <div className="max-w-3xl mx-auto prose prose-lg">
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  Ao acessar e usar o site da Andorinha Marketing ("Site"), você concorda em
                  cumprir e estar vinculado a estes Termos de Uso. Se você não concordar com
                  qualquer parte destes termos, não deve usar nosso Site.
                </p>
                <p className="text-muted-foreground">
                  Estes termos constituem um acordo legal entre você ("Usuário") e a Andorinha
                  Marketing ("nós", "nosso" ou "Empresa").
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  infrinja os direitos de terceiros ou restrinja o uso do Site por outros.
                </p>
                ...
                <p className="text-muted-foreground">
                  O Site é destinado a usuários maiores de 18 anos. Ao usar o Site, você
                  declara ter capacidade legal para celebrar este acordo.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  vídeos, áudio e software, é de propriedade exclusiva da Andorinha Marketing
                  ou de seus licenciadores e está protegido por leis de direitos autorais e
                  propriedade intelectual.
                </p>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  As informações sobre nossos serviços no Site são de caráter informativo.
                  A contratação efetiva de serviços está sujeita a:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  <li>Proposta comercial específica para cada projeto</li>
                  <li>Contrato de prestação de serviços assinado pelas partes</li>
                  <li>Termos e condições específicos de cada serviço</li>
                </ul>
                <p className="text-muted-foreground mt-4">
                  Os preços exibidos no Site são referenciais e podem variar conforme a
                  complexidade e escopo de cada projeto.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  O Site é fornecido "como está" e "conforme disponível". Não garantimos que:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground mb-4 space-y-2">
                  <li>O Site estará sempre disponível ou livre de erros</li>
                  <li>Os resultados obtidos pelo uso do Site serão precisos</li>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  O Site pode conter links para sites de terceiros. Estes links são fornecidos
                  apenas para sua conveniência e não implicam endosso ou responsabilidade
                  pelo conteúdo desses sites.
                </p>
                <p className="text-muted-foreground">
                  Não temos controle sobre o conteúdo, políticas de privacidade ou práticas
                  de sites de terceiros e não assumimos responsabilidade por eles. Recomendamos
                  que você revise os termos e políticas de qualquer site que visitar.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground">
                  Você concorda em indenizar e isentar a Andorinha Marketing, seus diretores,
                  funcionários e parceiros de qualquer reclamação, dano, perda ou despesa
                  (incluindo honorários advocatícios) decorrentes de: (a) seu uso do Site;
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground">
                  O uso continuado do Site após alterações constitui aceitação dos novos
                  termos. Recomendamos que você revise esta página periodicamente.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground">
                  ...
                  sem aviso prévio, se acreditarmos que você violou estes Termos ou por
                  qualquer outro motivo a nosso critério. Após a rescisão, todas as
                  disposições que por sua natureza devam sobreviver continuarão em vigor.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-muted-foreground">
                  ...
                  comarca de São Paulo, SP, com exclusão de qualquer outro, por mais
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  <li>
                    ...
                    completo entre você e a Andorinha Marketing
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Divisibilidade:</strong> Se qualquer disposição for considerada
                    inválida, as demais permanecerão em vigor
                  </li>
                  <li>
                    <strong>Cessão:</strong> Você não pode ceder seus direitos sob estes
                    Termos sem nosso consentimento
                  </li>
                </ul>
              </div>
