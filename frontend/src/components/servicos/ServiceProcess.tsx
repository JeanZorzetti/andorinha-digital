    ...
    <section className="py-16 lg:py-24 bg-primary-dark text-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg font-body text-white/80 max-w-2xl mx-auto">{subtitle}</p>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Step number */}
                  <div className="absolute -top-3 -left-3 w-8 h-8 bg-primary rounded-full flex items-center justify-center text-sm font-bold font-heading">
                    {index + 1}
                  </div>
                  ...
                  <p className="text-white/70 text-sm font-body mb-2">{step.description}</p>
